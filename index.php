...
<body id="top">
    ...
    <section class="container-fluid margin_for_fixed_menu hero-banner" id="hero-banner">
        ...
        <div class="carousel-inner">
            <div class="item active">
                <picture>
                    <source media="(min-width: 1400px)" srcset="img/PPC_Bodrum_Feature_Desktop.webp">
                    <source media="(max-width: 650px)" srcset="img/PPC_Bodrum_Feature_Desktop650.webp">
                    <img src="img/PPC_Bodrum_Feature_Desktop1200.webp" title="<?= __('site_img_alt') ?>" alt="<?= __('site_img_alt') ?>"  />
                </picture>
    ...
    <?php // Trustpilot Rates
    ?>
    <section class="container-fluid trustpilot carousel slide" id="trustpilot" data-touch="true" data-ride="carousel">
        <div class="row carousel-inner">
            <div class="col-lg-4  active">
                <div class="stars">
                    <img src="img/Trustpilot_5Stars.svg" title="<?= __('site_img_alt') ?>" alt="<?= __('site_img_alt') ?>" />
                </div>

                <h4><?= __('rate1_title') ?></h4>
                <p><?= __('rate1_p') ?></p>
                <div class="writer_name"><?= __('rate1_writer') ?></div>
                <div class="rate_date"><?= __('rate1_date') ?></div>

                <div class="trustpilot_logo">
                    <img src="img/Mono_Trustpilot_Logo.svg" title="<?= __('site_img_alt') ?>" alt="<?= __('site_img_alt') ?>" />
                </div>
            </div>
            ...
            <div class="col-lg-4 ">
                ...
                <h4><?= __('rate2_title') ?></h4>
                <p><?= __('rate2_p') ?></p>
                <div class="writer_name"><?= __('rate2_writer') ?></div>
                <div class="rate_date"><?= __('rate2_date') ?></div>
            ...
            <div class="col-lg-4 ">
                ...
                <h4><?= __('rate3_title') ?></h4>
                <p><?= __('rate3_p') ?></p>
                <div class="writer_name"><?= __('rate3_writer') ?></div>
                <div class="rate_date"><?= __('rate3_date') ?></div>
        ...
        <div class="hideWeb">
            <a class="carousel-control-prev" href="#trustpilot" role="button" data-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="sr-only">Previous</span>
            </a>
            <a class="carousel-control-next" href="#trustpilot" role="button" data-slide="next">
    ...
    <section class="container-fluid partners" id="partners">
        <div class="row">
            ...
            <div class="col-lg-4 side_2 l_side_border">
                <h3><?= __('partners_with') ?></h3>
                <div class="row justify-content-center">
                    <div class="col-6 logo_img">
                        <img src="img/Designer_Turkey_Logo.svg" title="<?= __('site_img_alt') ?>" alt="<?= __('site_img_alt') ?>" />
                    </div>
                    <div class="col-6 logo_img">
                        <img src="img/Funding_Turkey_Logo.svg" title="<?= __('site_img_alt') ?>" alt="<?= __('site_img_alt') ?>" />
                    </div>
                </div>
            </div>
            
            <div class="col-lg-3 side_3">
    ...
    <footer class="container-fluid footer" id="footer">
        ...
        <div class="hideIt">
            <img src="img/Form_Consultation_Desktop.webp" alt="modal header" title="<?= __('site_img_alt') ?> header" />
            <img src="img/Form_Contact_Desktop.webp" alt="modal header" title="<?= __('site_img_alt') ?> header" />
            <img src="img/Form_Property_Desktop.webp" alt="modal header" title="<?= __('site_img_alt') ?> header" />
            <img src="img/Form_News_Desktop.webp" alt="modal header" title="<?= __('site_img_alt') ?> header" />
            <img src="img/message.webp" alt="modal header" title="<?= __('site_img_alt') ?> header" />
            <img src="img/loader.svg" alt="modal header" title="<?= __('site_img_alt') ?> header" />
        </div>
    </footer>
