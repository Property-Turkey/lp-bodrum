    ...
    $LOCALE = [
        "en" => [
            "site_img_alt" => "Property Turkey - Bodrum",
            ...
            "separator_phrase_1" => "One-Stop Shop for Turkish Real Estate",
            "separator_phrase_2" => "Near Blue Flag Beaches, Marinas",
            "separator_phrase_3" => "Breathtaking Mediterranean Views",
            ...
            "offer3_txt" => "Designer Homes with Panoramic<br/>Views of Gumusluk Bay",

            "offer4_txt" => "Shoreside Beach Apartment<br/>in Gümüşlük, Bodrum",
            "offer5_txt" => "Stylish Villa with Private Pool<br/>and Stunning Garden",
            "offer6_txt" => "Creme de la Creme<br/>of Bodrum",
            ...
            "we_make_owning_property_easy" => "The Pearl of the Mediterranean, Antalya, Holds Many More Treasures Beyond Golden Rays",
            "we_make_owning_property_easy_p" => "<p>Set in the heart of the Turkish Riviera, Antalya rules the Eastern Mediterranean. It is a unique modern metropolis littered with pockets of exquisite nature and ancient human history. It really is the capital of the region where many smaller beach towns shoot out from either side, up and down the coast.</p><p>Antalya, is famous for its blue flag beaches that stretch a mind blowing length in front of the city center. But the true beauty may lie at altitude. The unique geography of Antalya, allows its residents and visitors access to the sea and the summit within a single day. All that nature sound exhausting? Stay behind and rejuvenate in one of the hundred resort style residences in town.</p>",

            "news1_title" => "Top 7 Boutique Hotels in Bodrum",
            "news1_date" => date('F d, Y', strtotime('-21 DAYS')),
            "news2_title" => "Bodrum with Children: Best Kids Activities in Bodrum",
            "news2_date" => date('F d, Y', strtotime('-30 DAYS')),
